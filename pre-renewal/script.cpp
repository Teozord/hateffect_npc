...
BUILDIN_FUNC(close)
{
	...
	return SCRIPT_CMD_SUCCESS;
	if(battle_config.efeitosonoro && sd->state.efeitosonoro == 1){
		clif_soundeffect(sd->bl, "close.wav", 0, SELF);
	}
}
...
// Data: 12 de Fevereiro de 2025 ás 06h25
// Diff: Ativa um icone falso em seu personagem
//---------------------------------------------------------------------------------
...
// (^~_~^) Gepard Shield End
	...
	BUILDIN_DEF(iconeFalso,"iiii"), //Adicionado por Magmaring#0352
	BUILDIN_DEF(fstatus,"iiii"), //Adicionado por Magmaring#0352
	BUILDIN_DEF(goto,"l"),
